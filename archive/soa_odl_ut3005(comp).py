    ...
    try:
        ...
        for idx, (voltage, current, delay) in enumerate(params, 1):
            ...
            if current_voltage_batch is not None and voltage != current_voltage_batch:
                build_voltage_maps(current_voltage_batch, main_folder, collected_data)
            ...
            rf_freq_max, rf_amplitude_max, rf_smsr_max= rf_measurement(
                rf_device=rf_device, N=NUMBER_RF_MEASURE, folder_path=main_folder,
            ...
            oscilloscope_measurement(device=oscilloscope, save_folder_path=main_folder, filename=base_filename, folder_structure=base_folder_structure, channel=4, save_png=None)
