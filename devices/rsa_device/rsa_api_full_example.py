...
#chdir(r"C:\Tektronix\RSA_API\lib\x64")
...
"""################SPECTRUM EXAMPLE################"""
def config_spectrum(cf=3e9, refLevel=0, span=40e6, rbw=300e3,):
    ...
    config_spectrum(self.cf, self.refLevel, self.span, self.rbw, self.start, self.stop)
...
def config_if_stream(cf=1e9, refLevel=0, fileDir=r'C:\SignalVu-PC Files', fileName='if_stream_test', durationMsec=100):
	rsa.CONFIG_SetCenterFreq(c_double(cf))
	rsa.CONFIG_SetReferenceLevel(c_double(refLevel))
