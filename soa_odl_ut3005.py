...
def main():
    ...
    try:
        ...
        for idx, (wavelength, voltage, current, delay) in enumerate(params, 1):
            ...
            oscilloscope_measurement(device=oscilloscope, save_folder_path=main_folder, filename=base_filename, folder_structure=base_folder_structure, channel=4, save_png=True)
