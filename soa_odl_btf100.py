...
def main():
    ...
    try:
        ...
        for idx, (linewidth, wavelength,current, delay) in enumerate(params, 1):
            base_folder_structure = f"wavelength_{wavelength}nm/current_{current}mA"
            ...
            rf_max_dict=rf_measurement(
                ...
                f_start=RF_F_START_MAX, f_stop=RF_F_STOP_MAX,rf_level=RF_LEVEL, save_png=True)
            ...
            rf_mid_dict= rf_measurement(
                ...
                f_span=RF_SPAN_MID, f_center=rf_peak_freq_max, rf_level=RF_LEVEL, save_png=True)
            ...
            rf_min_dict = rf_measurement(
                ...
                f_center=rf_peak_freq_mid, f_span=RF_SPAN_MIN,rf_level=RF_LEVEL,save_png=True)
            ...
            # mid_index = len(CURRENTS) // 2
            # if current == [CURRENTS[0], CURRENTS[-1], CURRENTS[mid_index]]:
            #     yoko_measurement(
            #                 device=yoko, 
            #                  save_folder_path=main_folder,
            #                  filename=base_filename,
            ...
            if current == CURRENTS[-1] and delay == DELAYS[-1]:
                ...
                maps_folder_structure = f'{main_folder}/maps/wavelength_{wavelength}nm'
